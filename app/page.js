...
const COPY = {
  en: {
    ...
    heroH1a: "Discover Japan's Best",
    heroH1b: 'Independent Music',
    ...
    ctaPrimary: 'Join as Curator →',
    ctaGhost: 'See How It Works',
    whyLabel: 'Why OTONAMI',
    whyTitle: 'Built for Curators Who Value Quality',
    whySub: 'We filter the noise so you only hear music that genuinely fits your audience.',
    why1Title: 'AI-Matched Pitches',
    why1Body: "Our matching engine analyzes genre, mood, and audio features to send you only the music that fits your playlist's style and audience — not random submissions.",
    why2Title: 'Get Paid to Listen',
    why2Body: 'Earn $3–5 per review, paid directly via PayPal. Transparent, guaranteed compensation for your time and expertise.',
    why3Title: "Japan's Hidden Gems",
    why3Body: "Access 70+ independent labels through ILCJ, Japan's largest indie label coalition. Discover artists before they go global.",
    howLabel: 'How It Works',
    howTitle: 'Three Steps to Start Discovering',
    howSub: 'Sign up in minutes. We handle the curation so you can focus on the music.',
    step1Title: 'Sign up and set your preferences',
    step1Body: 'Tell us your genres, moods, and share your playlist URL. Takes under 3 minutes. We use this to build your match profile.',
    step2Title: 'Receive AI-matched pitches',
    step2Body: "Our Match Score engine compares each artist's audio features, genre, and mood against your preferences. Only high-match submissions reach your inbox.",
    step3Title: 'Review, earn, and discover',
    step3Body: 'Listen, leave feedback, and get paid via PayPal. Add tracks you love to your playlist — and build direct relationships with Japanese artists and labels.',
    statsLabel: 'Backed by the Industry',
    statsTitle: "Japan's Indie Scene, Curated for You",
    stat1Label: 'Independent Labels\nvia ILCJ',
    stat2Label: 'Artists Featured at\nSXSW & Blue Note Tokyo',
    stat3Label: 'Powered by Audio\nMatch Score Technology',
    stat4Label: 'Earned Per Review\nvia PayPal',
    artLabel: 'For Artists & Labels',
    artTitle: 'Are you a Japanese artist or label?',
    ...
    footerTagline: 'Connecting Japanese Music to the World',
    footerBy: 'A project by TYCompany LLC / ILCJ',
    footerLink1: 'Curator Sign Up',
    footerLink2: 'Submit Music',
    footerLink3: 'Contact',
  },
  ja: {
    navHow: '使い方',
    ...
    ctaPrimary: 'キュレーターとして参加 →',
    ctaGhost: '使い方を見る',
    whyLabel: 'なぜOTONAMI？',
    whyTitle: 'クオリティを重視するキュレーターのために',
    whySub: 'ノイズをフィルタリングし、あなたのオーディエンスに本当に合う音楽だけをお届けします。',
    why1Title: 'AIマッチングピッチ',
    why1Body: 'ジャンル・ムード・音響特性を分析し、あなたのプレイリストに合った楽曲だけを送信。ランダムな投稿は一切届きません。',
    why2Title: '聴いて報酬を獲得',
    why2Body: '1件のレビューで$3〜5をPayPalで直接受け取れます。透明性があり、保証された報酬体系です。',
    why3Title: '日本の隠れた名曲',
    why3Body: '日本最大のインディーレーベル連合ILCJを通じて70以上のレーベルにアクセス。世界進出前のアーティストをいち早く発見しましょう。',
    howLabel: '使い方',
    howTitle: '3ステップで始める',
    howSub: '数分で登録完了。キュレーションはOTONAMIが担当するので、音楽に集中できます。',
    step1Title: '登録してジャンルを設定',
    step1Body: 'ジャンル・ムード・プレイリストURLを教えてください。3分以内で完了。この情報をもとにマッチプロフィールを構築します。',
    step2Title: 'AIマッチのピッチを受信',
    step2Body: 'Match Scoreエンジンがアーティストの音響特性・ジャンル・ムードをあなたの設定と比較。高マッチのピッチだけが届きます。',
    step3Title: 'レビュー・報酬・発見',
    step3Body: '聴いてフィードバックを残し、PayPalで報酬を受け取りましょう。気に入った楽曲はプレイリストに追加、日本のアーティスト・レーベルと直接つながれます。',
    statsLabel: '業界に支持されたプラットフォーム',
    statsTitle: '日本のインディーシーン、キュレーションして世界へ',
    stat1Label: 'ILCJ加盟\nインディーレーベル数',
    stat2Label: 'SXSW・Blue Note Tokyo\n出演アーティスト',
    stat3Label: 'AI音楽マッチング\n技術搭載',
    stat4Label: '1レビューの報酬\nPayPalにて',
    artLabel: 'アーティスト・レーベルの方へ',
    artTitle: '日本のアーティスト・レーベルの方へ',
    artBody: 'OTONAMIはAI生成の英語ピッチメールで、日本のアーティストが海外キュレーターにリーチするお手伝いをします。楽曲を入力してプロフェッショナルなピッチメールを生成、相性の良いキュレーターに数分で送信できます。',
    artCta: '楽曲を投稿する →',
    footerTagline: '日本の音楽を世界へ',
    footerBy: 'TYCompany LLC / ILCJ プロジェクト',
    footerLink1: 'キュレーター登録',
    footerLink2: '楽曲を投稿',
    footerLink3: 'お問い合わせ',
  },
};
    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .lang-btn { font-size: 0.75rem; font-weight: 600; padding: 0.3rem 0.55rem; background: none; color: #64748b; border: none; cursor: pointer; font-family: inherit; transition: background 0.12s, color 0.12s; line-height: 1; }
        ...
        .hero::before { content: ''; position: absolute; inset: 0; pointer-events: none; background: radial-gradient(ellipse 80% 60% at 20% 10%, rgba(99,102,241,0.22) 0%, transparent 60%), radial-gradient(ellipse 60% 50% at 80% 90%, rgba(16,185,129,0.18) 0%, transparent 55%), radial-gradient(ellipse 50% 40% at 50% 50%, rgba(99,102,241,0.08) 0%, transparent 60%); }
        .hero::after { content: ''; position: absolute; inset: 0; pointer-events: none; opacity: 0.04; background-image: radial-gradient(circle, #fff 1px, transparent 1px); background-size: 28px 28px; }
        ...
        .stat-label { font-size: 0.85rem; color: #64748b; line-height: 1.5; white-space: pre-line; }
        ...
        <div className="stats-band-inner">
          <div ref={statsRef} className="fade-section">
            ...
            <div className="stats-grid">
              ...
              <div className="stat">
                <div className="stat-num">SXSW</div>
        ...
        <div className="wrap">
          <div ref={artRef} className="fade-section">
            <div className="artist-box">
              <div>
                <div className="section-label" style={{marginBottom:'0.45rem'}}>{t.artLabel}</div>
                <h2>{t.artTitle}</h2>
                <p>{t.artBody}</p>
              </div>
